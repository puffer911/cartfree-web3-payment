...
interface ITokenMessenger {
     ...
     * The new BurnMessage will reuse the amount and nonce from the original.
     * @param originalMessage original message bytes (to replace)
     * @param originalAttestation attestation of original message
    ...
    /**
     * @notice Returns the local MessageTransmitter responsible for sending and receiving messages
     * @return localMessageTransmitter The local MessageTransmitter
     */
